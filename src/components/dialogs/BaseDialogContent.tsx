    ...
    ({ showCloseButton = true, className, children }) => {
        return (
            <ResponsiveDialogContent
                ...
                className={cn("w-full h-fit rounded-b-3xl p-[clamp(1rem,4vw,1.5rem)] border border-zinc-200/60 dark:border-zinc-800/60 bg-gradient-to-br from-zinc-100/70 to-zinc-50 dark:from-zinc-900/60 dark:to-zinc-950/40 backdrop-blur-xl shadow-xl transition-all", className)}
            >
                {/* Ambient glow */}
