...
export const DeleteAlertDialog = React.memo(({ type = "content", clearAllContent }: Props) => {
    return (
        <AlertDialog>
            ...
            <AlertDialogContent className="rounded-xl border border-zinc-200/50 dark:border-zinc-800/50 bg-gradient-to-br from-zinc-100 to-zinc-300 dark:from-zinc-900/70 dark:to-zinc-950/50 backdrop-blur-xl shadow-inner px-[clamp(1rem,4vw,1.5rem)] py-[clamp(1.25rem,5vw,1.75rem)] transition-all duration-300">
                {/* Ambient glow */}
                <AmbientGlow />
