        ...
        <section id={section.id} className="space-y-6">
            ...
            <div className="grid md:grid-cols-3 gap-6">
                {section.data.map((feature, index) => (
                    <div key={index} className="space-y-3 p-6 rounded-xl border border-zinc-200 dark:border-zinc-800 bg-gradient-to-br from-zinc-50 to-white dark:from-zinc-900 dark:to-zinc-800 hover:shadow-lg transition-all duration-200">
...
CodeFeaturesSection.displayName = "CodeFeaturesSection";