...
import { FileTilesGrid } from "@/components/custom/create-drop/tab/file-tab/FileTilesGrid";
import { DragAndDrop } from "@/components/custom/create-drop/tab/file-tab/DragAndDrop";
