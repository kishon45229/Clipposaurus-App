...
export const DropPreviewSkeleton = React.memo(() => {
    return (
        ...
        >
            <div className="flex w-full md:max-w-3xl lg:max-w-5xl xl:max-w-7xl mx-auto box-border rounded-lg shadow-lg overflow-hidden bg-zinc-100 dark:bg-zinc-900" role="main">
                <DropSidebarSkeleton />
